	...
	<view>
		...
		<view class="page-body">
			<view class="page-section page-section-gap">
				<map :show-location="showLocation" style="width: 100%; height: 300px;" :polyline="Polyline" :latitude="location.latitude"
...
<script>
	...
	export default {
		data() {
			return {
				Keystone: [
					"上半身挺直、双腿不要抬太高，会帮助你的跑步更平稳",
					"保持有节奏的呼吸，抓住跑步的节奏",
					"鼻子吸气、嘴巴呼气，这样可以避免空气气流进入呼吸道的时候过猛过激"
				],
				icon_suspend: false,
				twinkle: false,
				close: true,
