	...
	<view class="login">
		<view class="content">
			...
			<view class="other_login cuIcon">
				...
				<view class="login_icon">
					<view class="cuIcon-weibo" @tap="oauth"></view>
				</view>
...
<script>
	...
	export default {
		...
		onLoad: function(opotions) {
			...
			console.log(opotions.phoneData);
			this.phoneData = opotions.phoneData
			
			// // #ifdef APP-PLUS
			// uni.login({
			// 	success: (res) => {
			// 		console.log(JSON.stringify(res)); // {  res对象格式
			// 		// 	"code": "0430LjK60B2d6G1xyfN60g3tK600LjK-",
			// 		// 	"authResult": {
			// 		// 		"access_token": "31_dlM8UV26NYZQgK5H0dqAIqsAXiszoA2kcgdS-pyDtrwN8sTYNFNB2kDzuRqxCqMSqJTfCbou5DfRwbSBr-0a6X3YtcTnIGtj2ETpTIIrXg4",
			// 		// 		"code": "0430LjK60B2d6G1xyfN60g3tK600LjK-",
			// 		// 		"expires_in": 7200,
			// 		// 		"openid": "oRrdQt_U-oVtc9eOUT1HAlpE4NWI",
			// 		// 		"refresh_token": "31_b6kRSdzxaISJRP2G2cbzWSShEpeqAAsetsuFb6DPuW5GYcSZfb94ZH03nBn82DFndvzSOhEf0TssGDAsRKQ-QgYa_UFAIpPaiMimeoNP_sk",
			// 		// 		"scope": "snsapi_userinfo",
			// 		// 		"unionid": "oU5YytyThnb0WRENpzO_zy0w2YqY"
			// 		// 	},
			// 		// 	"errMsg": "login:ok"
			// 		// }
			// 		uni.getUserInfo({
			...
			// 				// 	"rawData": "{\"openId\":\"oRrdQt_U-oVtc9eOUT1HAlpE4NWI\",\"nickName\":\"jinx-志豪\",\"gender\":1,\"city\":\"\",\"province\":\"Venezia\",\"country\":\"Italy\",\"avatarUrl\":\"http://thirdwx.qlogo.cn/mmopen/vi_32/DYAIOgq83eo12OdicNVXPibic6VbTTdj8sRV8nuUweQUOC2uT5Ms4zDjh53ts3NCSickdMS2hg9H3hmyjicia9r8CoGA/132\",\"unionId\":\"oU5YytyThnb0WRENpzO_zy0w2YqY\"}",
			// 				// 	"userInfo": {
			// 				// 		"openId": "oRrdQt_U-oVtc9eOUT1HAlpE4NWI",
			// 				// 		"nickName": "jinx-志豪",
			// 				// 		"gender": 1,
			...
			// 				// 		"province": "Venezia",
			// 				// 		"country": "Italy",
			// 				// 		"avatarUrl": "http://thirdwx.qlogo.cn/mmopen/vi_32/DYAIOgq83eo12OdicNVXPibic6VbTTdj8sRV8nuUweQUOC2uT5Ms4zDjh53ts3NCSickdMS2hg9H3hmyjicia9r8CoGA/132",
			// 				// 		"unionId": "oU5YytyThnb0WRENpzO_zy0w2YqY"
			// 				// 	},
			// 				// 	"signature": ""
			// 				// }
		...
		methods: {
			...
			startLogin() {
				...
				uni.request({
					sslVerify:false,
					url: this.apiServer+'user/signin',
